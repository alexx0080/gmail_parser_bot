...
@study_router.message(Command('show_github'))
...
@study_router.message(Command('share_data'))
...
@study_router.message(Command('generate_person'))
...
# Buttons to ask FAQ
@study_router.message(Command('faq'))
